function plot_sim_data_SpeedUpW_Group(aal,si,speedUpLabel,thetaVal,legTitle,sort_n90,highlightPtrn_n90,saveOutputFigures,outputDir,imgFormat,oFileSuffix,useFDR,N,nodeLabels,showCommData,sortNodesBy,showDataColor)
...
%         tTestColorProp = { 'ColorArr', tTestColorArr, 'ColorLim1', [-2,2] };
    ...
    cMap_autumn = flipud(autumn(size(get(groot,'DefaultFigureColormap'),1)));
    cMap_winter = winter(size(get(groot,'DefaultFigureColormap'),1));
