 ...
 *
 * PhaseTransition_emxutil.h
 *
 * Code generation for function 'PhaseTransition_emxutil'
 *
 */

#ifndef PHASETRANSITION_EMXUTIL_H
#define PHASETRANSITION_EMXUTIL_H
...
/* End of code generation (PhaseTransition_emxutil.h) */
