...
MAKEFILE = NetworkActivationTime_mex.mk

include NetworkActivationTime_mex.mki


SRC_FILES =  \
	NetworkActivationTime_mexutil.cpp \
	NetworkActivationTime_data.cpp \
	NetworkActivationTime_initialize.cpp \
	...
	EvolveSINetwork.cpp \
	calcSpTime.cpp \
	_coder_NetworkActivationTime_info.cpp \
	_coder_NetworkActivationTime_api.cpp \
	_coder_NetworkActivationTime_mex.cpp \
	NetworkActivationTime_emxutil.cpp \
	cpp_mexapi_version.cpp

MEX_FILE_NAME_WO_EXT = NetworkActivationTime_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\NetworkActivationTime"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NetworkActivationTime/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NetworkActivationTime/%.cpp
	$(CC) $(CPPFLAGS) "$<"
