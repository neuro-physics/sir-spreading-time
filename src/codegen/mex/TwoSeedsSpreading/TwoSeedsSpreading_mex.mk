...
MAKEFILE = TwoSeedsSpreading_mex.mk

include TwoSeedsSpreading_mex.mki


SRC_FILES =  \
	TwoSeedsSpreading_mexutil.cpp \
	TwoSeedsSpreading_data.cpp \
	...
	calcSpTime.cpp \
	_coder_TwoSeedsSpreading_info.cpp \
	_coder_TwoSeedsSpreading_api.cpp \
	_coder_TwoSeedsSpreading_mex.cpp \
	TwoSeedsSpreading_emxutil.cpp \
	cpp_mexapi_version.cpp

MEX_FILE_NAME_WO_EXT = TwoSeedsSpreading_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\TwoSeedsSpreading"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\TwoSeedsSpreading/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\TwoSeedsSpreading/%.cpp
	$(CC) $(CPPFLAGS) "$<"
