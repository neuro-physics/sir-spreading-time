...
MAKEFILE = EvolveSINetworkAndCountActive_mex.mk

include EvolveSINetworkAndCountActive_mex.mki


SRC_FILES =  \
	EvolveSINetworkAndCountActive_data.cpp \
...
MEX_FILE_NAME_WO_EXT = EvolveSINetworkAndCountActive_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\EvolveSINetworkAndCountActive"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\EvolveSINetworkAndCountActive/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\EvolveSINetworkAndCountActive/%.cpp
	$(CC) $(CPPFLAGS) "$<"
