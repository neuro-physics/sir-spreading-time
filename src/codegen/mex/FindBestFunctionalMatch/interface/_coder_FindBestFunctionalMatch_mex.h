 ...
 *
 * _coder_FindBestFunctionalMatch_mex.h
 *
 * Code generation for function '_coder_FindBestFunctionalMatch_mex'
 *
 */

#ifndef _CODER_FINDBESTFUNCTIONALMATCH_MEX_H
#define _CODER_FINDBESTFUNCTIONALMATCH_MEX_H
...
/* End of code generation (_coder_FindBestFunctionalMatch_mex.h) */
