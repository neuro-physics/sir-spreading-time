...
MAKEFILE = FindBestFunctionalMatch_mex.mk

include FindBestFunctionalMatch_mex.mki


SRC_FILES =  \
	FindBestFunctionalMatch_mexutil.cpp \
	FindBestFunctionalMatch_data.cpp \
	...
	sortIdx.cpp \
	calcSpTime.cpp \
	_coder_FindBestFunctionalMatch_info.cpp \
	_coder_FindBestFunctionalMatch_api.cpp \
	_coder_FindBestFunctionalMatch_mex.cpp \
	FindBestFunctionalMatch_emxutil.cpp \
	cpp_mexapi_version.cpp

MEX_FILE_NAME_WO_EXT = FindBestFunctionalMatch_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\FindBestFunctionalMatch"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\FindBestFunctionalMatch/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\FindBestFunctionalMatch/%.cpp
	$(CC) $(CPPFLAGS) "$<"
