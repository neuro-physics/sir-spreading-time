...
static emlrtRSInfo bc_emlrtRSI = { 84, /* lineNo */
  "sort",                              /* fcnName */
  "C:\\Program Files\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sort.m"/* pathName */
};
...
static emlrtRTEInfo kc_emlrtRTEI = { 52,/* lineNo */
  1,                                   /* colNo */
  "sort",                              /* fName */
  "C:\\Program Files\\MATLAB\\R2017b\\toolbox\\eml\\eml\\+coder\\+internal\\sort.m"/* pName */
};
                   ...
                   emxArray_int32_T *idx)
{
  ...
  emxInit_real_T1(sp, &vwork, 1, &kc_emlrtRTEI, true);
  vstride = vwork->size[0];
  vwork->size[0] = i15;
  emxEnsureCapacity_real_T1(sp, vwork, vstride, &ic_emlrtRTEI);
  x_idx_0 = x->size[0];
  vstride = idx->size[0];
  idx->size[0] = x_idx_0;
  emxEnsureCapacity_int32_T(sp, idx, vstride, &ic_emlrtRTEI);
  st.site = &vb_emlrtRSI;
  vstride = 1;
  ...
  j = 0;
  emxInit_int32_T(sp, &iidx, 1, &ic_emlrtRTEI, true);
  while (j + 1 <= vstride) {
    st.site = &yb_emlrtRSI;
