...
MAKEFILE = EvolveSINetwork_mex.mk

include EvolveSINetwork_mex.mki


SRC_FILES =  \
	EvolveSINetwork_data.cpp \
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\EvolveSINetwork"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\EvolveSINetwork/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\EvolveSINetwork/%.cpp
	$(CC) $(CPPFLAGS) "$<"
