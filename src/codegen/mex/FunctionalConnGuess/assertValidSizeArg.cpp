...
void assertValidSizeArg(const emlrtStack *sp, real_T varargin_2)
{
  ...
  if (!(2.147483647E+9 >= b_varargin_2)) {
    emlrtErrorWithMessageIdR2012b(sp, &hc_emlrtRTEI, "Coder:MATLAB:pmaxsize", 0);
  }
}
