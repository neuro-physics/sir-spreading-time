                  ...
                  real_T x)
{
  ...
  i10 = (int32_T)i;
  if (!((i10 >= 1) && (i10 <= i9))) {
    emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&nc_emlrtBCI, sp);
  }
  ...
  while (j <= (int32_T)nodes->data[(int32_T)i - 1].par.n - 1) {
    ...
    i10 = (int32_T)i;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&oc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i10 = (int32_T)i;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&qc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i10 = nodes->data[(int32_T)i - 1].neigh->size[0];
    if (!((j + 1 >= 1) && (j + 1 <= i10))) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, i10, (emlrtBCInfo *)&vc_emlrtBCI,
        sp);
    }

    i10 = (int32_T)nodes->data[(int32_T)i - 1].neigh->data[j];
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&pc_emlrtBCI, sp);
    }

    i9 = nodes->data[(int32_T)i - 1].w->size[0];
    i10 = j + 1;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&rc_emlrtBCI, sp);
    }
    ...
    i10 = (int32_T)i;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&sc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i10 = (int32_T)i;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&tc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i10 = nodes->data[(int32_T)i - 1].neigh->size[0];
    if (!((j + 1 >= 1) && (j + 1 <= i10))) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, i10, (emlrtBCInfo *)&xc_emlrtBCI,
        sp);
    }

    i10 = (int32_T)nodes->data[(int32_T)i - 1].neigh->data[j];
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&wc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i11 = nodes->data[(int32_T)i - 1].neigh->size[0];
    if (!((j + 1 >= 1) && (j + 1 <= i11))) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, i11, (emlrtBCInfo *)&ad_emlrtBCI,
        sp);
    }

    i11 = (int32_T)nodes->data[(int32_T)i - 1].neigh->data[j];
    if (!((i11 >= 1) && (i11 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i11, 1, i9, (emlrtBCInfo *)&yc_emlrtBCI, sp);
    }
    ...
    i10 = (int32_T)i;
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&uc_emlrtBCI, sp);
    }

    i9 = nodes->size[1];
    i10 = nodes->data[(int32_T)i - 1].neigh->size[0];
    if (!((j + 1 >= 1) && (j + 1 <= i10))) {
      emlrtDynamicBoundsCheckR2012b(j + 1, 1, i10, (emlrtBCInfo *)&cd_emlrtBCI,
        sp);
    }

    i10 = (int32_T)nodes->data[(int32_T)i - 1].neigh->data[j];
    if (!((i10 >= 1) && (i10 <= i9))) {
      emlrtDynamicBoundsCheckR2012b(i10, 1, i9, (emlrtBCInfo *)&bd_emlrtBCI, sp);
    }
