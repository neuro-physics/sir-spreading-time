...
static emlrtRTEInfo n_emlrtRTEI = { 62,/* lineNo */
  9,                                   /* colNo */
  "GetSimulationParam",                /* fName */
  "D:\\Dropbox\\p\\postdoc\\programs\\matlab\\sirs\\spreading\\src\\GetSimulationParam.m"/* pName */
};
...
static emlrtRTEInfo bc_emlrtRTEI = { 23,/* lineNo */
  19,                                  /* colNo */
  "randperm",                          /* fName */
  "C:\\Program Files\\MATLAB\\R2017b\\toolbox\\eml\\lib\\matlab\\randfun\\randperm.m"/* pName */
};

static emlrtRTEInfo cc_emlrtRTEI = { 20,/* lineNo */
  19,                                  /* colNo */
  "randperm",                          /* fName */
  "C:\\Program Files\\MATLAB\\R2017b\\toolbox\\eml\\lib\\matlab\\randfun\\randperm.m"/* pName */
};
  ...
  *p_seedTrial, emxArray_real_T *p_x0)
{
  ...
  emxEnsureCapacity_real_T(sp, p_seeds, m, &l_emlrtRTEI);
  if (!(nSim >= 0.0)) {
  ...
  emlrtForLoopVectorCheckR2012b(1.0, 1.0, nSim, mxDOUBLE_CLASS, (int32_T)nSim,
    (emlrtRTEInfo *)&ac_emlrtRTEI, sp);
  i = 0;
  emxInit_int32_T(sp, &r1, 1, &t_emlrtRTEI, true);
  emxInit_real_T1(sp, &r2, 2, &t_emlrtRTEI, true);
  emxInit_real_T(sp, &hashTbl, 1, &p_emlrtRTEI, true);
  emxInit_real_T(sp, &link, 1, &q_emlrtRTEI, true);
  emxInit_real_T(sp, &val, 1, &r_emlrtRTEI, true);
  emxInit_real_T(sp, &loc, 1, &s_emlrtRTEI, true);
  while (i <= (int32_T)nSim - 1) {
    m = p_seeds->size[0];
    nleftm1 = i + 1;
    if (!((nleftm1 >= 1) && (nleftm1 <= m))) {
      emlrtDynamicBoundsCheckR2012b(nleftm1, 1, m, (emlrtBCInfo *)&lb_emlrtBCI,
        sp);
    }
    ...
    m = r1->size[0];
    r1->size[0] = nleftm1;
    emxEnsureCapacity_int32_T(sp, r1, m, &m_emlrtRTEI);
    for (m = 0; m < nleftm1; m++) {
      r1->data[m] = m;
    }
    ...
    r2->size[0] = 1;
    r2->size[1] = (int32_T)nSeeds;
    emxEnsureCapacity_real_T(&b_st, r2, m, &o_emlrtRTEI);
    ...
    if (!(nSeeds == 0.0)) {
      if ((int32_T)nSeeds >= N) {
        ...
        for (nleftm1 = 0; nleftm1 <= N - 2; nleftm1++) {
          ...
          r2->data[nleftm1 + 1] = r2->data[(int32_T)(j + 1.0) - 1];
          r2->data[(int32_T)(j + 1.0) - 1] = (1.0 + (real_T)nleftm1) + 1.0;
        }
        ...
        for (m = 0; m < (int32_T)nSeeds; m++) {
          ...
          j = muDoubleScalarFloor(selectedLoc);
          r2->data[m] = r2->data[(int32_T)(j + 1.0) - 1];
          r2->data[(int32_T)(j + 1.0) - 1] = t;
        }
      } else {
        m = hashTbl->size[0];
        hashTbl->size[0] = (int32_T)nSeeds;
        emxEnsureCapacity_real_T1(&b_st, hashTbl, m, &p_emlrtRTEI);
        nleftm1 = (int32_T)nSeeds;
        for (m = 0; m < nleftm1; m++) {
          hashTbl->data[m] = 0.0;
        }
        ...
        emxEnsureCapacity_real_T1(&b_st, link, m, &q_emlrtRTEI);
        nleftm1 = (int32_T)nSeeds;
        for (m = 0; m < nleftm1; m++) {
          link->data[m] = 0.0;
        }
        ...
        emxEnsureCapacity_real_T1(&b_st, val, m, &r_emlrtRTEI);
        nleftm1 = (int32_T)nSeeds;
        for (m = 0; m < nleftm1; m++) {
          val->data[m] = 0.0;
        }
        ...
        emxEnsureCapacity_real_T1(&b_st, loc, m, &s_emlrtRTEI);
        nleftm1 = (int32_T)nSeeds;
        for (m = 0; m < nleftm1; m++) {
          loc->data[m] = 0.0;
        }
        ...
        for (m = 0; m < (int32_T)nSeeds; m++) {
          ...
          if (j > 0.0) {
            r2->data[m] = val->data[(int32_T)j - 1] + 1.0;
          } else {
            r2->data[m] = selectedLoc + 1.0;
            j = newEntry;
            newEntry++;
    ...
    nleftm1 = r2->size[1];
    for (m = 0; m < nleftm1; m++) {
      p_seeds->data[i + p_seeds->size[0] * r1->data[m]] = r2->data[r2->size[0] *
        m];
    }
  ...
  if (nSeeds < 1.0) {
    ...
    p_x0->size[0] = 1;
    p_x0->size[1] = 0;
    emxEnsureCapacity_real_T(sp, p_x0, m, &l_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(sp, p_x0, m, &n_emlrtRTEI);
