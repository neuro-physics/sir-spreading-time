function [fh, axh, lh] = plotBrainSurf(fh, axh, brainColor, alphaValue, lightPos, shiftZCoord, contourLevel, contourArgs, countourPerpAxis)
    ...
    if (nargin < 9) || isempty(countourPerpAxis)
        countourPerpAxis = 'z';
    end
    ...
    if isempty(contourLevel)
        ...
        [~,sz] = getSurfaceContour(brain,contourLevel,[],0,countourPerpAxis);
