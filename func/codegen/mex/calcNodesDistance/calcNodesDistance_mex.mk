...
MAKEFILE = calcNodesDistance_mex.mk

include calcNodesDistance_mex.mki


SRC_FILES =  \
	calcNodesDistance_data.cpp \
	...
	calcNodesDistance_emxutil.cpp

MEX_FILE_NAME_WO_EXT = calcNodesDistance_mex
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\calcNodesDistance"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\calcNodesDistance/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\calcNodesDistance/%.cpp
	$(CC) $(CPPFLAGS) "$<"
