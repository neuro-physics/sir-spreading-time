/*
 * findLinearTransformation_emxutil.cpp
 *
 * Code generation for function 'findLinearTransformation_emxutil'
 *
 */
...
/* End of code generation (findLinearTransformation_emxutil.cpp) */
