...
MAKEFILE = getNiiParcelCoord_mex.mk

include getNiiParcelCoord_mex.mki


SRC_FILES =  \
	getNiiParcelCoord_data.cpp \
...
SYS_INCLUDE += /I "$(START_DIR)\codegen\mex\getNiiParcelCoord"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\getNiiParcelCoord/%.c
	$(CC) $(CFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\getNiiParcelCoord/%.cpp
	$(CC) $(CPPFLAGS) "$<"
