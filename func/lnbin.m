function [midpts, Freq, eFreq, LFreq, widths, ends]=lnbin(x,BinNum)
...
%
% midpts -> ponto medio de cada janela do histograma
% Freq -> frequencia de pontos em cada janela do histograma
% eFreq -> erro estimado para cada frequencia
% LFreq -> quantidade de pontos em cada janela do histograma
% widths -> largura de cada janela do histograma
% ends -> limites esquerdo e direito de cada janela; ends(:,1) -> esquerda; ends(:,2) -> direita
    x=sort(x);
    i=1;
    while x(i)<=0
       i=i+1; 
